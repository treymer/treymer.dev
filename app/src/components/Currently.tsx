          ...
          {items.map((item) => {
            ...
            return item.href ? (
              <Link
                ...
                className="group relative block rounded-xl border border-[#8B6914] bg-[#F4E4C1] p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-[#D4A017] hover:shadow-[0_12px_32px_rgba(0,0,0,0.5),0_0_20px_rgba(109,40,217,0.15)]"
              >
                {cardContent}
              </Link>
            ) : (
